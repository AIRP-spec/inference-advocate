...
// criteria, because this evaluator is a judge rather than a regex. Template v2.1 is the live
// decode; judgment content is unchanged from v2. Remaining failures are fine-tune candidates,
// not a reason to weaken cases.
